<script lang="ts">
	...
	// Add this after your other let declarations
	...
	async function handleSave() {
		...
		try {
			...
			const response = await api(authFetch).createProductType(productTypeData);
			toast.success('Product type created successfully');
			goto(`/${$page.params.shop}/product-types/${response.id}/edit`);
		} catch (error) {
