...
<div class="grid gap-6">
	<Card.Root>
		<Card.Header>
			<Card.Title>Social Settings</Card.Title>
		...
		<Card.Content>
			<form method="POST" class="space-y-8"  id="general-settings-form">
				<div class="flex w-full flex-col gap-3">
					...
					<Input id="domain" />
					<p class="text-muted-foreground text-sm">Your store's domain name.</p>
				</div>
	
				<div class="flex w-full flex-col gap-3">
					<Label for="custom-domain">Custom Domain</Label>
					<Input id="custom-domain" />
					<p class="text-muted-foreground text-sm">Custom domain if applicable.</p>
				</div>
			</form>
		</Card.Content>
