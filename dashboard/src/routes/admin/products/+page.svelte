<script lang="ts">
	...
	queryFn: () => api(authFetch).getProducts(limit),
	})
</script>
		...
		<Tabs.Root value="all">
			<div class="flex items-center">
				...
				<div class="ml-auto flex items-center gap-2">
					...
					<Button size="sm" class="h-7 gap-1" href="/admin/products/create">
											...
											<Table.Cell>
												<DropdownMenu.Root>
													...
													<DropdownMenu.Content align="end">
														...
														<DropdownMenu.Item href="/admin/products/{product?.product_id || ''}/">
															Edit
														</DropdownMenu.Item>
