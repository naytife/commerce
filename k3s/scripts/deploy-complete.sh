...
echo -e "\n${BLUE}📊 Step 6: Final Status Check${NC}"
echo "----------------------------"
sleep 5
...
echo "  🔑 Auth Handler:     http://127.0.0.1:3001"
echo "  🏗️  Cloud Build:      http://127.0.0.1:9001"
echo "  🐘 PostgreSQL:       localhost:5433"
echo "  📊 Redis:            localhost:6380"
echo "  🆔 Hydra Public:     http://127.0.0.1:4446"
echo "  🆔 Hydra Admin:      http://127.0.0.1:4447"

echo -e "\n${BLUE}📚 Quick Links:${NC}"
echo "==============="
echo "  📖 API Documentation:   http://127.0.0.1:8081/v1/docs"
echo "  🎮 GraphQL Playground:  http://127.0.0.1:8081/playground"
echo "  ❤️  Health Checks:       http://127.0.0.1:8081/health"
