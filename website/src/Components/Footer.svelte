<script>
	import naytifelogo from '/src/lib/images/naytifelogo.svg';
</script>

<footer class="bg-gray-200 bg-opacity-90 py-10">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-green-950">
