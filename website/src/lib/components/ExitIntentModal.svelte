<script lang="ts">
    ...
    import { Rocket, ArrowRight, CheckCircle } from 'lucide-svelte';
    export let showExitIntent: boolean;
    export let close: () => void;
  </script>
  
  {#if showExitIntent}
    <div class="fixed inset-0 z-200 flex items-center justify-center bg-black/50 backdrop-blur-xs animate-fade-in">
      <div class="glass rounded-3xl p-8 border border-primary/20 max-w-lg mx-6 animate-scale-in shadow-2xl">
        ...
        <div class="text-center">
          <div class="w-16 h-16 bg-linear-to-br from-primary to-accent rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-brand">
