  ...
  <div class="container mx-auto px-6">
    <div class="glass rounded-3xl p-12 border border-border/50">
      ...
      <div class="grid gap-8 md:grid-cols-4 text-center">
        <div>
          <div class="text-4xl md:text-5xl font-bold bg-linear-to-r from-primary to-accent bg-clip-text text-transparent mb-2">
            10,000+
          </div>
        ...
        <div>
          <div class="text-4xl md:text-5xl font-bold bg-linear-to-r from-accent to-secondary bg-clip-text text-transparent mb-2">
            ₦50M+
          </div>
        ...
        <div>
          <div class="text-4xl md:text-5xl font-bold bg-linear-to-r from-secondary to-primary bg-clip-text text-transparent mb-2">
            99.9%
          </div>
        ...
        <div>
          <div class="text-4xl md:text-5xl font-bold bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent mb-2">
            4.9/5
          </div>
